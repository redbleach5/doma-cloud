...
describe("EmptyState component", () => {
  ...
  describe("shared-root view", () => {
    it("renders the empty shared-root copy", () => {
      render(<EmptyState view="shared-root" />);
      expect(screen.getByText("Пока нет общих файлов")).toBeTruthy();
      expect(screen.getByText(/появятся здесь/i)).toBeTruthy();
    });
  });
