...
// Locale for date formatting. Set DOMA_LOCALE in .env to override (e.g.
// "en-US"); otherwise the browser's default locale is used. Falls back to
// ru-RU on the server (no navigator).
const DATE_LOCALE =
  process.env.DOMA_LOCALE ??
