...
/**
 * LightRays — canvas-декорация: тёплый диагональный «луч света» с медленно
 * дрейфующими пылинками.
 *
 * Реализация: canvas 2D + requestAnimationFrame.
 *   - ~45 частиц на десктопе (45 * density)
 *   - на мобильных и при prefers-reduced-motion не рисуется вовсе
