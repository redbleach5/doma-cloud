...
/**
 * DropGlow — брызги из точки drop при загрузке файлов через drag&drop.
 *
 * Подписывается на событие "doma:drop-burst" (CustomEvent) из FileBrowser.
 * Капли — абсолютно позиционированные div'ы с CSS-анимацией, удаляются
 * после завершения; canvas и общий RAF не задействованы.
 */
