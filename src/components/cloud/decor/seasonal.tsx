...
/**
 * SeasonalAccent — очень тонкие сезонные акценты на фоне.
 *
 ...
 *
 * Rendered to a <canvas> and animated via direct 2D-context draws inside
 * requestAnimationFrame — this keeps React state out of the hot loop. The
 * previous implementation called setParticles() on every RAF frame, which
 * forced React to diff and re-render N absolutely-positioned divs 60 times
 * per second, jankying the UI on low-end devices.
 */
