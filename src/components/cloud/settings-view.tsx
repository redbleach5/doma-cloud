    ...
    <div className="max-w-2xl mx-auto p-4 sm:p-6 pb-24 space-y-6">
      ...
      <Card className="border-primary/10">
        <CardHeader>
          ...
          <CardDescription>Как вас зовут в Doma</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-muted-foreground">
              Логин нельзя изменить. Используется для входа и WebDAV.
            </p>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            />
            <p className="text-xs text-muted-foreground">
              В этот день Doma покажет тёплое поздравление с мерцающей свечой.
            </p>
          </div>
      ...
      <Card className="border-primary/10">
        <CardHeader>
          ...
          <CardDescription>Используется для входа и WebDAV</CardDescription>
        </CardHeader>
        <CardContent>
