...
/**
 * Doma FolderStack — папка как стопка листов со смещением.
 *
 * Когда курсор не на папке: видно три листа, сложенных стопкой,
 * верхний слегка повёрнут — ощущение физической глубины.
 *
 * На hover: верхний лист приподнимается (translateY + scale),
 * тёплое свечение под стопкой, как будто папку только что подняли со стола.
 *
 * Используем SVG для чёткой векторной графики на любом разрешении.
 */
