      ...
      fetch(req)
        ...
        .catch(() =>
          caches.match(req).then((r) => r || caches.match("/") || new Response(
            "<!doctype html><meta charset=utf-8><title>Офлайн</title><body style='font-family:system-ui;padding:2rem;text-align:center'>«Наша история» сейчас офлайн. Подключитесь к сети и обновите страницу.</body>",
